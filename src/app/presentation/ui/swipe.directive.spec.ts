...
describe('SwipeDirective', () => {
  ...
  it('émet swipeLeft sur un glissement vers la gauche', () => {
  ...
  it('émet swipeRight sur un glissement vers la droite', () => {
  ...
  it('ignore un geste majoritairement vertical (scroll)', () => {
    dir.onTouchStart(touch(root, 100, 100));
  ...
  it('ignore un petit déplacement sous le seuil', () => {
    dir.onTouchStart(touch(root, 100, 100));
  ...
  it('ignore un swipe démarré dans une zone [data-no-swipe] (bracket)', () => {
